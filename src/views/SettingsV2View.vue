<template>
  <div class="settings-container">
    ...
    <div class="settings-content">
      ...
      <!-- Account Section -->
      <div id="account" class="section-anchor">
        ...
        <!-- Team Section -->
        <div id="team" class="section-anchor">
          <div class="settings-section">
        ...
        <div id="integrations" class="section-anchor">
          <div class="settings-section">
        ...
        <!-- API Keys Section -->
        <div id="api-keys" class="section-anchor">
          <div class="settings-section">
            <div class="section-header">
              <h3>API Keys</h3>
        ...
        <!-- Audit Log Section -->
        <div id="audit-log" class="section-anchor">
          <div class="settings-section">
            <h3>Activity Log</h3>
